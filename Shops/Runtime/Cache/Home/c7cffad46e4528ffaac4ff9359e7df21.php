...
<div id="site-nav" class="w-full">
   <div class="shoptop w clearfix">
      <div class="login_info">
         您好,
                  游客         <a href="index.php?app=member&amp;act=login&amp;ret_url=http%3A%2F%2Flocalhost%2Fjiuxian%2F">登录</a>
         <a href="index.php?app=member&amp;act=register&amp;ret_url=http%3A%2F%2Flocalhost%2Fjiuxian%2F">注册</a>
               </div>
      <ul class="quick-menu">
...
<div id="_widget_369" name="jiuxian_image_ads" widget_type="widget" class="widget">
	<div class="global-image-ads" style="">
		...
		<div class="col-sub">
            ...
            <div class="content">
        		<form method="post" id="login_form" action="/myshop/index.php/Home/MemLogin/MemLogin">
                	<dl class="clearfix">
                    	<dt>用户名</dt>
                        <dd>
                    ...
                    <dl class="clearfix">
                    	<dt>&nbsp;</dt>
                        <dd>
                        	<img src="/myshop/index.php/Home/MemLogin/genecode" id="code" name="code" width="150" height="40">
                        	<a href="javascript:refresh()">看不清换一张</a>
                            <div class="clr"></div><label></label>
                        </dd>
                    </dl>
                	...
                	<dl class="clearfix">
                  		...
                  		<dd class="register-now">
                        	如果您还不是会员，请<a href="index.php?app=member&amp;act=register&amp;ret_url=http%3A%2F%2Flocalhost%2Fjiuxian%2F" title="注册">注册</a><br/>
                        </dd>
               		</dl>
...
function refresh()
{
	document.getElementById('code').src="/myshop/index.php/Home/MemLogin/genecode/"+Math.random();	
}
</script>
</html>