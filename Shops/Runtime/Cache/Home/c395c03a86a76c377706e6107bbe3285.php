...
<div id="site-nav" class="w-full">
   <div class="shoptop w clearfix">
      <div class="login_info">
         您好,
                  游客         <a href="<?php echo U('MemLogin/Mem_login');?>">登录</a>
         <a href="<?php echo U('MemRegister/Mem_register');?>">注册</a>
               </div>
      <ul class="quick-menu">
...
<a href="" target="_blank"><img  width="502px"  height="350px" class="lazyload" initial-url="/myshop/Public/images/home/201401020405319180.png" /></a>
		...
		<div class="col-sub">
            ...
            <div class="content">
        		<form method="post" id="login_form" action="<?php echo U('MemLogin/Mem_login');?>">
                	<dl class="clearfix">
                    	<dt>用户名</dt>
                        <dd>
                    ...
                    <dl class="clearfix">
                    	<dt>&nbsp;</dt>
                    	<dd>
                            <img id="codeImg" src="<?php echo U('MemLogin/genecode');?>" width="150" height='30' >
                	...
                	<dl class="clearfix">
                  		...
                  		<dd class="register-now">
                        	如果您还不是会员，请<a href="<?php echo U('MemRegister/Mem_register');?>" title="注册">注册</a><br/>
                        </dd>
               		</dl>
...
<script>
function changeCode(){
	$("#codeImg").attr('src',"<?php echo U('Home/MemLogin/genecode/id/"+Math.random()+"');?>");
}
</script>
</html>