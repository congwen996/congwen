...
<link rel="stylesheet" type="text/css" href="/myshop/Public/js/home/jquery.plugins/poshy_tip/tip-yellowsimple/tip-yellowsimple.css"  /><!--<editmode></editmode>-->
</head>
<body>
<div id="site-nav" class="w-full">
   <div class="shoptop w clearfix">
      ...
      <ul class="quick-menu">
        <li class="home"><a href="http://localhost/jiuxian">回到首页</a></li> 
        <li class="item">
            <div class="menu mytb">
...
<div id="page-register" class="w login-register mt20 mb20">
	<div class="w logo mb10">
		<p><a href="http://localhost/jiuxian" title="仿酒仙运营版演示站"><img alt="仿酒仙运营版演示站" src="/myshop/Public/images/home/site_logo.gif" /></a></p>
	</div>
	<div class="w clearfix">
		...
		<div class="login-field">
			<span>我已经注册过帐号，立即<a href="<?php echo U('MemLogin/Mem_login');?>" class="login-field-btn">登录</a></span>
		...
		<div class="form">
    		<div class="title">用户注册</div>
       	 	<div class="content">
				<form id="register_form" method="post" action="<?php echo U('MemRegister/Mem_register');?>">            
                	...
                	<dl class="clearfix">
                		<dt>验证码</dt>
                    	<dd>
                    		<input class="input" type="text" id="captcha" name="captcha" title="请输入正确的验证码" />
                        	<div class="clr"></div><label></label>
                    	</dd>
                	</dl>
                	<dl class="clearfix">
                		<dt>&nbsp;</dt>
                    	<dd>
                    		<img id="codeImg" src="<?php echo U('MemRegister/genecode');?>" width="150" height="30">
                    	...
                    	<dd class="mall-eula">
                    		<input id="clause" type="checkbox" name="agree" value="1" class="agree-checkbox" checked="checked" />
                 			<span>我已阅读并同意 <a href="index.php?app=article&amp;act=system&amp;code=eula" target="_blank">用户服务协议</a></span>
                        	<div class="clr"></div><label></label>
                    	</dd>
               	 	</dl>
                	<dl class="clearfix">
...
<script>
function changeCode(){
	$("#codeImg").attr('src',"<?php echo U('MemRegister/genecode/id/"+Math.random()+"');?>")
}
</script>
</body>
</html>