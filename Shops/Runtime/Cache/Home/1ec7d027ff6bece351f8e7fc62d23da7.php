...
.ware_list th {text-align:left;}
	...
	<script type="text/javascript" src="/myshop/Public/js/home/jquery-1.8.3.js"></script>
...
$(function(){
    $("#deimg").diyUpload({
		 //处理文件上传
		 url:"<?php echo U('MemUserinfo/upFile');?>",
	 	 success:function(d){
	 		$("#oldimg").attr("src","/myshop/"+d.imgsrc);
	 		$("#mimg").val(d.imgsrc);
	 	 },
	 	 error:function(e){
	 		console.info(e);
...
$(function(){
  ...
  <script>
    ...
    <div id="right">
            <div class="submenu">
        <ul class="tab">
                                    <li class="active first"><h2><a href="javascript:;">基本信息</a></h2></li>
                                </ul>
</div>            <div class="wrap">
                <div class="public">
                <form action="<?php echo U('MemUserinfo/Mem_userinfo');?>" method="post" enctype="multipart/form-data" id="profile_form">
                    <div class="information">
                       <div class="photo width13">
                            <p><img src="/myshop/<?php echo ($memArr['mimg']); ?>" width="120" height="120" alt="" ectype="avatar" id="oldimg" /></p>
                             <div id="deimg"></div>
                       	...
                       	<div class="info individual">
                            <table>
                                <tr>
                                    ...
                                    <td><?php echo ($memArr['user_name']); ?><input type="hidden" name="user_id" value="<?php echo ($memArr['user_id']); ?>"></td>
                                </tr>
                                <tr>
                                    <th>您的密码:</th>
                                    <td><input type="password" class="text width_normal" name="old_pwd" value="" /></td>
                                </tr> 
                                <tr>
                                    <th> 新密码:</th>
                                    <td><input type="password" class="text width_normal" name="password" value="" /></td>
                                </tr> 
                                <tr>
                                    <th>确认密码:</th>
                                    <td><input type="password" class="text width_normal" name="new_pwd_2" value="" /></td>
                                </tr>                                                                                                
                                <tr>
                                    <th>电子邮箱:</th>
                                ...
                                <tr>
                                    <th>真实姓名:</th>
                                    <td><input type="text" class="text width_normal" name="real_name" value="<?php echo ($memArr['real_name']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>性别: </th>
                                    <td class="label">
                                        <label>
                                           <input type="radio" name="gender" value="0" <?php if(($memArr['gender']) == "0"): ?>checked<?php endif; ?> /> 保密  </label>
                                            <label>
                                            <input type="radio" name="gender" value="1" <?php if(($memArr['gender']) == "1"): ?>checked<?php endif; ?> />男   </label>
                                            <label>
                                            <input type="radio" name="gender" value="2" <?php if(($memArr['gender']) == "2"): ?>checked<?php endif; ?> /> 女 </label>
                                    </td>
                                </tr>
                                <tr>
                                    <th>生日: </th>
                                    <td>
                                      <input type="text" class="text1 width2" name="birthday" id="birthday" value="<?php echo ($memArr['birthday']); ?>"/> 

                                    </td>
                                </tr>
                                <tr>
                                    <th>QQ:</th>
                                    <td> <input type="text" class="text width_normal" name="im_qq" value="<?php echo ($memArr['im_qq']); ?>" /></td>
                                </tr>
                                <tr>
                                    <th>MSN:</th>
                                    <td><input type="text"  class="text width_normal"name="im_msn" value="<?php echo ($memArr['im_msn']); ?>" /></td>
                                </tr>
                                                                <tr>
                                    <th></th>
